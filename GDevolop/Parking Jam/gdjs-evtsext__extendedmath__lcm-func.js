...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0xd9d6a0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
function gcf(a, b) {
    while (a != b) {
        if (a > b) {
...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0xd9d6a0(runtimeScene, eventsFunctionContext);
